...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      post: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`post: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('post',
                                     'argument 1 (as invoked from Typescript)',
                                     'bulletin_board.compact line 7 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._post_0(context, partialProofData);
  ...
  _post_0(context, partialProofData) {
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
