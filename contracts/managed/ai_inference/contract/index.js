...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      submit_inference_result: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`submit_inference_result: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('submit_inference_result',
                                     'argument 1 (as invoked from Typescript)',
                                     'ai_inference.compact line 13 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._submit_inference_result_0(context,
                                                         partialProofData);
    ...
    this.impureCircuits = {
      submit_inference_result: this.circuits.submit_inference_result
    };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
    ...
    state_0.setOperation('submit_inference_result', new __compactRuntime.ContractOperation());
  ...
  _submit_inference_result_0(context, partialProofData) {
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
